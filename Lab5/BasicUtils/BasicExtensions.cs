...
namespace BasicUtils
{
    public static class BasicExtensions
    {
        ...
        public static System.Collections.IEnumerable Each(
            this System.Collections.IEnumerable values,
            Action<object> eachAction
        )
        {
        ...
        public static VALUE Get<KEY, VALUE>(
        ...
        public static bool IsGenericEnumerable(this Type type)
        {
            ...
            return (
                ...
                || (type.IsInterface && (type.Name.IndexOf("IEnumerable") >= 0))
            );
        }
