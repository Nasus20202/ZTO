...
namespace BasicUtils
{
    ...
    public class BusinessRule<T> : IBusinessRule<T>, IRule
    ...
    public class BusinessRuleSet<T> : IBusinessRuleSet
        where T : IValidatedObject
    {
        // Fields
        ...
        public IList<string> Messages
        {
            get
            {
                return new List<IBusinessRule<T>>(this.rules).ConvertAll<string>(
                    delegate(IBusinessRule<T> rule)
                    {
